...
import { isEmpty, findIndex, intersection, uniq, difference, orderBy as orderBy$1, takeRight, map, groupBy, maxBy, minBy } from 'lodash';
...
var SettingOption = function SettingOption(_ref2) {
  ...
  var _useState = useState(currentOptions !== null && currentOptions !== void 0 && currentOptions.length ? currentOptions : defaultOptions({
    init: true
  })),
      options = _useState[0],
